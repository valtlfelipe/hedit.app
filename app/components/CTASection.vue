<template>
    <section class="py-24 px-4">
      <div class="max-w-4xl mx-auto text-center">
        <div class="relative">
          <div class="absolute inset-0 bg-gradient-glow rounded-3xl blur-3xl" />

          <div class="relative bg-card border border-border rounded-3xl p-12 shadow-elegant">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  class="border-border hover:bg-secondary px-8 py-6 text-lg"
                  as-child
                >
                <a href="https://github.com/valtlfelipe/hedit/issues/new/choose" target="_blank">
                  <LucideHeartHandshake class="w-5 h-5 mr-2" />
                  Share Feedback
                  </a>
                </Button>
            </div>
            ...
            <div class="mt-12 pt-8 border-t border-border">
              <div class="flex items-center justify-center gap-3 mb-4">
                ...
                <div class="text-left">
                  ...
                  <div class="text-sm text-muted-foreground">Felipe Valtl de Mello</div>
                </div>
              </div>
